...
<template>
      <section class="section">
            ...
            <div class="container_icons">
                  <div class="container_icons_txt">
                        <FontAwesomeIcon
                              :icon="faHtml5"
                              class="icons" />
                        <span class="span_techno">Html</span>
                  </div>
                  <div class="container_icons_txt">
                        <FontAwesomeIcon
                              :icon="faCss3Alt"
                              class="icons" />
                        <span class="span_techno">css</span>
                  </div>
                  <div class="container_icons_txt">
                        <FontAwesomeIcon
                              :icon="faSquareJs"
                              class="icons" />
                        <span class="span_techno">javascript</span>
                  </div>
                  <div class="container_icons_txt">
                        <svg
                              class="icons"
                        ...
                        <span class="span_techno">typescript</span>
                  </div>
                  <div class="container_icons_txt">
                        <FontAwesomeIcon
                              :icon="faVuejs"
                              class="icons" />
                        <span class="span_techno">vue js</span>
                  </div>
                  <div class="container_icons_txt">
                        <svg
                              class="icons"
                        ...
                        <span class="span_techno">next js</span>
                  </div>
                  <div class="container_icons_txt">
                        <svg
                              class="icons"
                        ...
                        <span class="span_techno">graphql</span>
                  </div>
                  <div class="container_icons_txt">
                        <svg
                              class="icons"
                        ...
                        <span class="span_techno">sql</span>
                  </div>
                  <div class="container_icons_txt">
                        <FontAwesomeIcon
                              :icon="faNodeJs"
                              class="icons" />
                        <span class="span_techno">nodejs</span>
                  </div>
                  <div class="container_icons_txt">
                        <FontAwesomeIcon
                              :icon="faPython"
                              class="icons" />
                        <span class="span_techno">python</span>
                  </div>
                  <div class="container_icons_txt">
                        <FontAwesomeIcon
                              :icon="faWebflow"
                              class="icons" />
                        <span class="span_techno">webflow</span>
                  </div>
                  <div class="container_icons_txt">
                        <FontAwesomeIcon
                              :icon="faFigma"
                              class="icons" />
                        <span class="span_techno">figma</span>
                  </div>
            </div>
      </section>
</template>
